...
public class FXVideo extends VideoDisplay
{
	...
	override protected function createChildren():void
	{
		...
		//CONTROLBAR VISIBLE SUR ROLLOVER
		///////////////DEBUT////////////////
		controlBar.visible = false;
		
		var montrer:Fade = new Fade();
		montrer.alphaTo = 1;
		montrer.duration = 200;
		
		var cacher:Fade = new Fade();
		cacher.alphaTo = 0;
		
		controlBar.setStyle("showEffect", montrer);
		controlBar.setStyle("hideEffect", cacher);
		
		addEventListener(MouseEvent.ROLL_OVER, function():void{cacher.stop();controlBar.visible = true});
		addEventListener(MouseEvent.ROLL_OUT, function():void{montrer.stop();controlBar.visible = false});
		////////////////FIN/////////////////
