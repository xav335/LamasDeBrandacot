    	...
    	<td valign="top">
			...
			<tr align="center""> 
			 	<td class="<? echo $class_ch?>" align="left"><a href="lien_modif.php?id_lien=<? echo $row["id_lien"]?>"><img src="modifier_off.gif" alt="" width="13" height="13" border="0"></a></td>
			  	...
			  	<td class="<? echo $class_ch?>" align="left"><a href="lien_suppr.php?id_lien=<? echo $row["id_lien"]?>" onclick="return confirm('êtes-vous sûr de vouloir supprimer la lien <? echo $row["id_lien"] ?> ?')"><img src="supprimer_off.gif" alt="" width="13" height="13" border="0"></a></td>
	        </tr>
				<? $cc++ ?>	
			<? }?>
	      	</table>
