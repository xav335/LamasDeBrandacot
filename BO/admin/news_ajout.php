...
<tr>
	<td align="center" valign="middle">
        ...
        <form action="news_ajout_2.php" method="post" name="formulaire"  onsubmit="return Form1_Validator(this)" enctype="application/x-www-form-urlencoded">
        	<input type="hidden" name="id_collecte" value="<? echo $id_collecte?>">
        	<tr>
            		<td align="center" id="texte3">Ajout Actu</td>
        	</tr>
        	<tr> 
